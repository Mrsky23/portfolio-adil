...
(function initProjects() {
  ...
  const ALL = [
    ...
    // CHARGÉE DE COMMUNICATION (5)
    { titre: 'Série 10 Questions',        cat: 'CHARGÉE DE COMMUNICATION', annee: '2025', format: 'landscape',
      ...
      client: 'TOMA Intérim',
      contexte: 'Série d\'interviews de franchisés TOMA Intérim — 10 questions directes sur leur parcours et ambitions. Un format pensé pour donner envie aux entrepreneurs de se lancer en franchise.',
    ...
    { titre: 'Focus Franchisé Sylvestre', cat: 'CHARGÉE DE COMMUNICATION', annee: '2025', format: 'landscape',
      ...
      roles: ['Communication', 'Motion Design', 'Tournage', 'Montage'] },
    { titre: 'Focus Consultant Brendan',  cat: 'CHARGÉE DE COMMUNICATION', annee: '2025', format: 'landscape',
      ...
      roles: ['Communication', 'Motion Design', 'Tournage', 'Montage'] },
    { titre: 'Vidéo UBB',                 cat: 'CHARGÉE DE COMMUNICATION', annee: '2025', format: 'landscape',
      ...
      client: 'TOMA Intérim',
      contexte: 'Motion design publicitaire diffusé sur l\'écran géant du stade UBB dans le cadre du partenariat TOMA Intérim × UBB.',
    ...
    { titre: 'Ouverture Saint-Maximin',   cat: 'CHARGÉE DE COMMUNICATION', annee: '2025', format: 'landscape',
    ...
    { titre: 'Tracking 3D',               cat: 'MOTION', annee: '2025', format: 'landscape',
      ...
      realisation: 'Projet personnel — tracking, compositing VFX, texturing, sound design.',
    ...
    { titre: 'Vidéo FDI',                 cat: 'MOTION', annee: '2025', format: 'landscape',
      ...
      client: 'TOMA Intérim',
      contexte: 'Mise en avant de la branche formation FDI de TOMA Intérim — jamais promue auparavant.',
    ...
    { titre: 'Polaris Motion 3D',         cat: 'MOTION', annee: '2025', format: 'landscape',
      ...
      client: 'TOMA Intérim',
      contexte: 'Animation 3D pour annoncer la gamme streetwear Polaris de TOMA Intérim. Casquette et t-shirt avec logo en relief effet broderie.',
    ...
    { titre: 'Ray Chair HAY',             cat: 'MOTION', annee: '2025', format: 'landscape',
      ...
      realisation: 'Modélisation partielle, texturing, lighting et animation 3D photoréaliste.',
    ...
    { titre: 'Morph',                     cat: 'GRAPHISME', annee: '2026', format: 'landscape',
      ...
      realisation: 'Création logo, DA, déclinaisons visuelles.',
      roles: ['Graphisme', 'Identité Visuelle', 'DA'] },
    { titre: 'TOMA Intérim',              cat: 'GRAPHISME', annee: '2024', format: 'landscape',
      img:   'https://res.cloudinary.com/dwgfd808v/image/upload/v1774374691/Toma_int%C3%A9rim_car%C3%A9e_blanc_pclwye.png',
      client: 'TOMA Intérim',
      contexte: 'Direction artistique globale de la gamme streetwear TOMA Intérim sur 3 ans — 4 logos distincts, chacun avec sa propre DA, ses couleurs et son univers.',
